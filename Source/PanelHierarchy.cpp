...
void PanelHierarchy::DrawNode(HierarchyNode* node)
{
	// Main Variables
	static ImGuiContext& g = *GImGui;
	static ImGuiWindow* window = g.CurrentWindow;
...
HierarchyNode* PanelHierarchy::CreateNode(HierarchyNode::NodeType type, HierarchyNode* parent, std::string name)
{
...
void PanelHierarchy::DeleteNodes(std::vector<HierarchyNode*> nodes_list, bool reorder)
{
...
void PanelHierarchy::DuplicateNodes(std::vector<HierarchyNode*> nodes_list, HierarchyNode* parent)
{
...
// --- MAIN HELPERS ---
HierarchyNode* PanelHierarchy::HandleSelection(HierarchyNode* node, bool is_hovered)
{
...
void PanelHierarchy::MoveNode(HierarchyNode* node, HierarchyNode* parent, HierarchyNode* pos, int indent)
{
...
bool PanelHierarchy::DrawRightClick()
{
...
bool PanelHierarchy::ShowSceneOptions(HierarchyNode* node)
{
...
void PanelHierarchy::DrawConnectorLines(HierarchyNode* node, ImDrawList* draw_list)
{
	// Error handling
	if (node == nullptr)
	{
...
int PanelHierarchy::FindNode(HierarchyNode* node, std::vector<HierarchyNode*> list)
{
...
uint PanelHierarchy::GetNameCount(HierarchyNode* node)
{
...
// --- NODE POS ---
void PanelHierarchy::ReorderNodes(HierarchyNode* node, bool is_delete)
{
...
uint PanelHierarchy::RecursivePos(HierarchyNode* node)
{
	if (node->childs.empty())
		return node->pos + 1;
	else
...
void PanelHierarchy::UpdateNode(HierarchyNode* node)
{
...
// --- CONNECTOR LINES ---
std::vector<HierarchyNode*> PanelHierarchy::GetHiddenNodes()
{
...
std::vector<HierarchyNode*> PanelHierarchy::GetAllChilds(HierarchyNode* node)
{
...
std::vector<HierarchyNode*> PanelHierarchy::GetClosedChilds(HierarchyNode* node)
{
...
bool PanelHierarchy::IsChildOf(HierarchyNode* parent, HierarchyNode* node)
{
...
HierarchyNode* PanelHierarchy::GetLastChild(HierarchyNode* node)
{
	if (node->childs.empty())
		return node;
	else
...
// --- SORTERS ---
std::vector<HierarchyNode*> PanelHierarchy::SortByPosition(std::vector<HierarchyNode*> list)
{
...
std::vector<HierarchyNode*> PanelHierarchy::SortByIndent(std::vector<HierarchyNode*> list)
{
